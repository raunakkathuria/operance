    ...
    *,
    ...
    return InstalledSmokeResult(
        ...
        manual_checks=[
            ...
            "Click the tray icon and say: minimize <visible window title>",
            "Click the tray icon and say: restore <visible window title>",
            "Click the tray icon and say: maximize <visible window title>",
            "Click the tray icon and say: close the <visible window title> window, then confirm",
