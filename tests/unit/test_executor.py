...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("what apps are open", ToolName.WINDOWS_LIST, "success", "Open windows: Firefox; Terminal"),
        ("is firefox open", ToolName.WINDOWS_FIND, "success", "Found 1 window: Firefox"),
        ("is code open", ToolName.WINDOWS_FIND, "success", "No open windows matched code"),
        ("switch to window firefox", ToolName.WINDOWS_SWITCH, "success", "Switched to window Firefox"),
        ("switch to firefox window", ToolName.WINDOWS_SWITCH, "success", "Switched to window Firefox"),
        ...
        ("time", ToolName.TIME_NOW, "success", "It is 09:41"),
        ("what is my battery level", ToolName.POWER_BATTERY_STATUS, "success", "Battery is 87%"),
        ("battery", ToolName.POWER_BATTERY_STATUS, "success", "Battery is 87%"),
        ("what is the volume", ToolName.AUDIO_GET_VOLUME, "success", "Volume is 30%"),
        ("volume", ToolName.AUDIO_GET_VOLUME, "success", "Volume is 30%"),
        ("is audio muted", ToolName.AUDIO_MUTE_STATUS, "success", "Audio is unmuted"),
        ("muted", ToolName.AUDIO_MUTE_STATUS, "success", "Audio is unmuted"),
        ...
        ("volume 50 percent", ToolName.AUDIO_SET_VOLUME, "success", "Volume set to 50%"),
        ("set volume 50", ToolName.AUDIO_SET_VOLUME, "success", "Volume set to 50%"),
        ("mute audio", ToolName.AUDIO_SET_MUTED, "success", "Audio muted"),
        ("mute", ToolName.AUDIO_SET_MUTED, "success", "Audio muted"),
        ("unmute audio", ToolName.AUDIO_SET_MUTED, "success", "Audio unmuted"),
        ("unmute", ToolName.AUDIO_SET_MUTED, "success", "Audio unmuted"),
