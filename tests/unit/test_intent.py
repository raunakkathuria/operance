...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("open fire fall", ToolName.APPS_LAUNCH, {"app": "firefox"}, RiskTier.TIER_0, False),
        ("open fire force", ToolName.APPS_LAUNCH, {"app": "firefox"}, RiskTier.TIER_0, False),
        ("open fire fox", ToolName.APPS_LAUNCH, {"app": "firefox"}, RiskTier.TIER_0, False),
        ("open terminal", ToolName.APPS_LAUNCH, {"app": "terminal"}, RiskTier.TIER_0, False),
        ("open the terminal", ToolName.APPS_LAUNCH, {"app": "terminal"}, RiskTier.TIER_0, False),
        ("open the browser", ToolName.APPS_LAUNCH, {"app": "browser"}, RiskTier.TIER_0, False),
        ("open my browser", ToolName.APPS_LAUNCH, {"app": "browser"}, RiskTier.TIER_0, False),
        ("open the default browser", ToolName.APPS_LAUNCH, {"app": "default browser"}, RiskTier.TIER_0, False),
        ("go to google.com", ToolName.APPS_LAUNCH, {"app": "https://google.com"}, RiskTier.TIER_0, False),
        (
            "visit docs.python.org/3",
            ToolName.APPS_LAUNCH,
            {"app": "https://docs.python.org/3"},
            RiskTier.TIER_0,
            False,
        ),
        (
            "open website github.com/raunakkathuria/operance",
            ToolName.APPS_LAUNCH,
        ...
        (
            "search google for operance ai desktop",
            ToolName.APPS_LAUNCH,
            {"app": "https://www.google.com/search?q=operance+ai+desktop"},
            RiskTier.TIER_0,
            False,
        ),
        (
            "google search for kde wayland automation",
            ToolName.APPS_LAUNCH,
            {"app": "https://www.google.com/search?q=kde+wayland+automation"},
            RiskTier.TIER_0,
            False,
        ),
        (
            ...
            ToolName.APPS_LAUNCH,
            {"app": "https://www.google.com/search?q=linux+automation"},
            RiskTier.TIER_0,
            False,
        ),
        (
        ...
        ("focus fire force", ToolName.APPS_FOCUS, {"app": "firefox"}, RiskTier.TIER_0, False),
        ...
        ("quit fire force", ToolName.APPS_QUIT, {"app": "firefox"}, RiskTier.TIER_2, True),
        ("list windows", ToolName.WINDOWS_LIST, {}, RiskTier.TIER_0, False),
        ("what apps are open", ToolName.WINDOWS_LIST, {}, RiskTier.TIER_0, False),
        ("show open windows", ToolName.WINDOWS_LIST, {}, RiskTier.TIER_0, False),
        ("is firefox open", ToolName.WINDOWS_FIND, {"window": "firefox"}, RiskTier.TIER_0, False),
        ("is firefox running", ToolName.WINDOWS_FIND, {"window": "firefox"}, RiskTier.TIER_0, False),
        ("find window terminal", ToolName.WINDOWS_FIND, {"window": "terminal"}, RiskTier.TIER_0, False),
        (
            "show windows matching browser",
        ...
        ("switch to firefox window", ToolName.WINDOWS_SWITCH, {"window": "firefox"}, RiskTier.TIER_0, False),
        ...
        ("what is the time", ToolName.TIME_NOW, {}, RiskTier.TIER_0, False),
        ("what is the current time", ToolName.TIME_NOW, {}, RiskTier.TIER_0, False),
        ("what's the time", ToolName.TIME_NOW, {}, RiskTier.TIER_0, False),
        ("tell me what time it is", ToolName.TIME_NOW, {}, RiskTier.TIER_0, False),
        ("show me the time", ToolName.TIME_NOW, {}, RiskTier.TIER_0, False),
        ("time", ToolName.TIME_NOW, {}, RiskTier.TIER_0, False),
        ("what is my battery level", ToolName.POWER_BATTERY_STATUS, {}, RiskTier.TIER_0, False),
        ("battery", ToolName.POWER_BATTERY_STATUS, {}, RiskTier.TIER_0, False),
        ("what is the volume", ToolName.AUDIO_GET_VOLUME, {}, RiskTier.TIER_0, False),
        ("volume", ToolName.AUDIO_GET_VOLUME, {}, RiskTier.TIER_0, False),
        ("is audio muted", ToolName.AUDIO_MUTE_STATUS, {}, RiskTier.TIER_0, False),
        ("muted", ToolName.AUDIO_MUTE_STATUS, {}, RiskTier.TIER_0, False),
        ...
        ("volume 50 percent", ToolName.AUDIO_SET_VOLUME, {"percent": 50}, RiskTier.TIER_1, False),
        ("set volume 50", ToolName.AUDIO_SET_VOLUME, {"percent": 50}, RiskTier.TIER_1, False),
        ...
        ("mute", ToolName.AUDIO_SET_MUTED, {"muted": True}, RiskTier.TIER_1, False),
        ("unmute audio", ToolName.AUDIO_SET_MUTED, {"muted": False}, RiskTier.TIER_1, False),
        ("unmute", ToolName.AUDIO_SET_MUTED, {"muted": False}, RiskTier.TIER_1, False),
        ...
        (
            ...
            ToolName.FILES_FIND,
            {"location": "home", "query": "notes.txt", "kind": "file"},
            RiskTier.TIER_0,
            False,
        ),
        (
            ...
            ToolName.FILES_FIND,
            {"location": "home", "query": "projects", "kind": "folder"},
            RiskTier.TIER_0,
            False,
        ),
        (
            ...
            ToolName.FILES_FIND,
            {"location": "downloads", "query": "report.pdf", "kind": "file"},
            RiskTier.TIER_0,
            False,
        ),
        (
            ...
            ToolName.FILES_FIND,
            {"location": "documents", "query": "invoice", "kind": "any"},
            RiskTier.TIER_0,
            False,
        ),
        (
            ...
            {"location": "home", "query": "notes.txt", "kind": "any"},
            RiskTier.TIER_0,
            False,
        ),
        (
            "how big is report.pdf in downloads",
            ToolName.FILES_GET_INFO,
            {"location": "downloads", "query": "report.pdf", "kind": "file"},
            RiskTier.TIER_0,
            False,
        ...
        (
            "when was invoice.pdf modified in documents",
            ToolName.FILES_GET_INFO,
            {"location": "documents", "query": "invoice.pdf", "kind": "any"},
            RiskTier.TIER_0,
            False,
        ),
        (
        ...
        ("open desktop", ToolName.FILES_OPEN, {"location": "desktop"}, RiskTier.TIER_0, False),
        ("open downloads", ToolName.FILES_OPEN, {"location": "downloads"}, RiskTier.TIER_0, False),
        ("open folder downloads", ToolName.FILES_OPEN, {"location": "downloads"}, RiskTier.TIER_0, False),
        ("show documents folder", ToolName.FILES_OPEN, {"location": "documents"}, RiskTier.TIER_0, False),
        ("open home folder", ToolName.FILES_OPEN, {"location": "home"}, RiskTier.TIER_0, False),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("open fire force and load localhost:3000", "http://localhost:3000"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("open fire force and notify me", "firefox"),
