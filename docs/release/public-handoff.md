...
- contextual follow-ups such as `open it`, `open the first one`, `copy the first one to documents`, `switch to it`, and `switch to the first window` after compatible file or window awareness results
