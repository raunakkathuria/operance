...
- create, copy, rename, move, or delete Desktop entries with confirmation where needed
- copy a known-folder file result with follow-ups such as `copy the first one to documents`
