...
list recent files, list or search known folders by file name, manage Desktop
files or folders with confirmation, list or switch windows, answer desktop-status
questions, and control basic audio state.
