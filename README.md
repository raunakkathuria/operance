...
- Contextual follow-ups: after file or window awareness results, users can say `open it`, `open the first one`, `switch to it`, or `switch to the first window`; Operance resolves those phrases into existing typed actions and still runs validation and policy before execution.
